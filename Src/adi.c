...
void ADI_Init(void) {
	...
	adi1.mode &= ~(AD7792_MODE_RATE(0xF) | AD7792_MODE_SEL(0xFF));
	adi1.mode |= (AD7792_MODE_RATE(AD7702_RATE_1_120ms) | AD7792_MODE_SEL(AD7792_MODE_IDLE));
	...
	adi1.fullscale[AD7792_CH_AIN2P_AIN2M] = 0x53A0; //0x54a3
